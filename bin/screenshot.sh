...
SCREENSHOTS_DIR=/home/invincible/Pictures/Screenshots
TIMESTAMP="$(date +%Y.%m.%d-%H.%M.%S)"
#TIMESTAMP="$(date +%Y.%m.%d--%s)"
FILENAME=$SCREENSHOTS_DIR/$TIMESTAMP.screenshot.png
PHOTO_ICON_PATH=/home/invincible/.icons/oomox-only_icons/categories/scalable/applications-photography.svg
