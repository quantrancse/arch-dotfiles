...
local xbackground = xrdb.background or "#2B2B2B"
local xforeground = xrdb.foreground or "#FDFDFD"
local xcolor0 = xrdb.color0 or "#323232"
...
theme.chrome_icon = icon_path .. "chrome.png"
...
theme.user_icon = icon_path .. "user.png"
theme.reader_icon = icon_path .. "reader.png"
