...
disk:buttons(gears.table.join(
                       ...
                       awful.button({ }, 3, function ()
                           awful.spawn(filemanager .. " /mnt/DATA", {floating = true})
                       end)
))
...
local hello_user = wibox.widget.textbox("Hello " .. username:sub(1,1):upper()..username:sub(2))
hello_user.font = "sans 15"
local user_icon = wibox.widget.imagebox(beautiful.user_icon)
user_icon.resize = true
user_icon.forced_width = 40
user_icon.forced_height = 40
