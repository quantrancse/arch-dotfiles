...
keys.desktopbuttons = gears.table.join(
    ...
    awful.button({ }, 9, function () awful.spawn.with_shell("./bin/volume-control.sh up") end),
    awful.button({ }, 8, function () awful.spawn.with_shell("./bin/volume-control.sh down") end)
...
keys.globalkeys = gears.table.join(
    ...
    awful.key( { superkey, shiftkey }, "Print", function() awful.spawn.with_shell("./bin/screenshot.sh -s") end,
              {description = "select area to capture", group = "screenshots"}),
    awful.key( { superkey, ctrlkey }, "Print", function() awful.spawn.with_shell("./bin/screenshot.sh -c") end,
              {description = "select area to copy to clipboard", group = "screenshots"}),
    awful.key( { superkey }, "Print", function() awful.spawn.with_shell("./bin/screenshot.sh -b") end,
              {description = "browse screenshots", group = "screenshots"}),
    awful.key( { superkey, altkey }, "Print", function() awful.spawn.with_shell("./bin/screenshot.sh -e") end,
    ...
    -- Media keys
    awful.key({ superkey }, "F8", function() awful.spawn.with_shell("mpc next") end,
    {description = "next song", group = "media"}),
    awful.key({ superkey }, "F7", function() awful.spawn.with_shell("mpc prev") end,
    {description = "previous song", group = "media"}),
    awful.key({ superkey }, "F6", function() awful.spawn.with_shell("mpc toggle") end,
    {description = "toggle pause/play", group = "media"}),
    awful.key({ superkey, shiftkey }, "F8", function() awful.spawn.with_shell("mpvc next") end,
    {description = "mpv next song", group = "media"}),
    awful.key({ superkey, shiftkey }, "F7", function() awful.spawn.with_shell("mpvc prev") end,
    {description = "mpv previous song", group = "media"}),
    awful.key({ superkey, shiftkey}, "F6", function() awful.spawn.with_shell("mpvc toggle") end,
    ...
    awful.key({ superkey }, "F1", function() awful.spawna.with_shell("./bin/lock") end,
    ...
    -- Spawn nemo in a terminal
    awful.key({ superkey }, "F3", function() awful.spawn(terminal .. "nemo") end,
    ...
    awful.key({ superkey }, "F4", function() awful.spawn(terminal .. " -e ncmpcpp") end,
    ...
    -- Open browser
    awful.key({ superkey }, "b", function() awful.spawn.with_shell("google-chrome-stable") end,
      {description = "chrome", group = "launcher"}),
    -- Open new vscode client frame
    awful.key({ superkey }, "e", function() awful.spawn.with_shell("code") end,
      {description = "vscode", group = "launcher"}),
    -- Open new emacs client frame
    awful.key({ superkey, shiftkey }, "e", function() awful.spawn.with_shell("emacs") end,
